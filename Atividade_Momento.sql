...
VALUES (207,'Larissa','Carvalho','larissa.carvalho@momento.org', '940028922','2023-08-12', 9, 4000.00,101,6);
...
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES (209,'Vanessa','Maiz','vanessa.maiz@momento.org', '956347896','2023-05-10', 3, 5000.00,101,1);
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES (210,'Pedro','Gustavo','pedro.gustavo@momento.org', '964571238','2023-05-10', 3, 5000.00,101,1);
